    ...
    <section className="relative overflow-hidden gradient-hero py-16 md:py-24">
      ...
      <div className="container relative">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          {/* Right Book Stack */}
          <div className="relative hidden lg:flex justify-center items-end gap-4 perspective-1000">
            {books.map((img, i) => (
              <div
                key={i}
              ...
              >
                ...
                <img
                  src={img}
                  alt={`Book ${i + 1}`}
                  className="w-48 h-72 object-cover rounded-lg shadow-book transition-all duration-300 group-hover:shadow-book-hover group-hover:-translate-y-2"
                />
              </div>
            ))}
          </div>
