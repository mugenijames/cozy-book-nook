...
export default function ProgramActivityPage() {
  ...
  const nextImage = () => {
    if (selectedImage === null || imageCount <= 1) return;
              ...
              >
                ...
                <div className="mt-8 border-t border-gray-200 pt-7">
                  ...
                  <div className="mt-5 space-y-3">
                    ...
                    {activity.highlights.slice(0, 5).map((highlight) => (
                      <Link
                        key={highlight.slug}
                        to={`/programs/${activity.slug}/${highlight.slug}`}
                        className="group flex items-start gap-3 rounded-xl p-2 -mx-2 transition-colors hover:bg-white"
                      >

                        <CheckCircle2 className="mt-0.5 h-5 w-5 shrink-0 text-[#D4A017]" />

                        <span className="text-sm leading-6 text-gray-600 group-hover:text-[#8B4513]">
                          {highlight.title}
                        </span>
          ...
          <div className="container mx-auto px-5 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="mx-auto mt-4 max-w-2xl leading-7 text-white/65">
                Explore the different areas through which this program
                creates meaningful and practical impact.
              </p>
            ...
            <div className="mx-auto mt-12 grid max-w-6xl gap-5 sm:grid-cols-2 lg:grid-cols-3">
              ...
              {activity.highlights.map((highlight, index) => (
                ...
                >
                  ...
                  <Link
                    to={`/programs/${activity.slug}/${highlight.slug}`}
                    className="group block h-full overflow-hidden rounded-2xl border border-white/10 bg-white/5 backdrop-blur-sm transition-all duration-300 hover:-translate-y-1 hover:border-[#D4A017]/40 hover:bg-white/10 hover:shadow-2xl"
                  >
                    ...
                    <div className="p-5">
                      ...
                      <span className="mt-5 inline-flex items-center gap-2 text-sm font-bold text-[#D4A017]">
          ...
          <div className="container mx-auto px-5 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="mx-auto mt-5 max-w-2xl leading-7 text-white/70">
                ...
                facilitate a session, or partner with your organization?
              </p>
