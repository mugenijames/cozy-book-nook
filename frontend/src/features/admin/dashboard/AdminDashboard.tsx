...
import { Badge } from "@/components/ui/badge"; // Now this will work
import { getBooks } from "@/services/api";

// Remove the Logo import if you don't have it, or create it
...
export default function AdminDashboard() {
  ...
  return (
    <div className="space-y-8">
      ...
      {/* Footer Section */}
      <footer className="border-t border-[#E8DDD4] pt-6 mt-8">
